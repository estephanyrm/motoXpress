...
_PERSIST_PATH = "db/undo_stack.json"
...
class UndoRedoManager:
    ...
    def _dict_to_cmd(self, d: dict) -> RegistrarVentaCommand:
        vd = d["venta"]
        venta = VentaVO(
        ...
        cmd = RegistrarVentaCommand(venta)   # financiacion ya en venta.financiacion
