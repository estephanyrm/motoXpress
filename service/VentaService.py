...
class VentaService:
    ...
    def registrar(self,
        ...
        if ClienteDAO.obtener_por_id(venta.id_cliente) is None:
            raise ValueError(
                f"No existe cliente con id {venta.id_cliente}."
            )
        ...
        if moto is None:
            raise ValueError(
                f"No existe moto con id {venta.id_moto}."
            )
        ...
        if EmpleadoDAO.obtener_por_id(venta.id_empleado) is None:
            raise ValueError(
                f"No existe empleado con id {venta.id_empleado}."
            )
    ...
    def obtener_detalle(
        ...
        return VentaDAO.obtener_por_id(
            id_venta
        )
    ...
    def listar_por_cliente(
        ...
        return VentaDAO.listar_por_cliente(
            id_cliente
        )
    ...
    def listar_por_periodo(
        ...
        return VentaDAO.listar_por_periodo(
            fecha_inicio,
            fecha_fin
        )